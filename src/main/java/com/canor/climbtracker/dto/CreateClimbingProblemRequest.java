...
public class CreateClimbingProblemRequest {
    ...
    public CreateClimbingProblemRequest(){}

    public CreateClimbingProblemRequest(String climbName, String grade, Integer setterId) {
